; (function ($, window, document, undefined) {
    ...
    var pluginName = 'mediumInsert',
        ...
        defaults = {
            label: '<span class="glyphicon glyphicon-facetime-video" title="Add a video"></span>',
    ...
    Embeds.prototype.oembed = function (url, pasted) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // hack to remove You're using demo endpoint of Iframely API commercially. Max-width is limited to 320px
                html = html.replace('<div style="max-width:320px;margin:auto;">', '');
