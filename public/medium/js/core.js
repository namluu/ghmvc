;(function ($, window, document, undefined) {
    ...
    Core.prototype.positionButtons = function (activeAddon) {
        ...
        if ($p.length) {
            position.left = $p.position().left + 15;
    ...
    Core.prototype.toggleAddons = function () {
        ...
        if (this.$el.find('.medium-insert-buttons-show').hasClass('medium-insert-buttons-rotate')) {
            this.$el.find('.medium-insert-buttons-show').prop('title', 'Close menu') ;
        } else {
            this.$el.find('.medium-insert-buttons-show').prop('title', 'Add an image, video or new part') ;
        }
    };
