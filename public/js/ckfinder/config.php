...
array_splice($rootFolder,-2);
$base_folder = implode(DS,$rootFolder);
define('PATH_BASE',$base_folder);
$orginal_base_path = str_replace('/',DS,$_SERVER['DOCUMENT_ROOT']);
$subfolder = (strpos(PATH_BASE,$orginal_base_path)!==FALSE)?str_replace($orginal_base_path,'',PATH_BASE):'';
/*
...
*/
//$baseUrl = ($subfolder?'/'.str_replace(DS,'/',$subfolder):'').'/images/';
$baseUrl = 'http://ghmvc.loc/public/images/';
...
ATTENTION: The trailing slash is required.
*/
$baseDir = resolveUrl((($subfolder)?DS.$subfolder.DS:DS)).DS.'images'.DS;
/*
 * ### Advanced Settings
 */
...
$config['Thumbnails'] = Array(
		'url' => $baseUrl . 'editors/_thumbs',
		'directory' => $baseDir . 'editors/_thumbs',
		'enabled' => true,
		'directAccess' => false,
		'maxWidth' => 100,
		'maxHeight' => 100,
...
$config['ResourceType'][] = Array(
		...
		'url' => $baseUrl . 'editors/files',
		'directory' => $baseDir . 'editors/files',
		'maxSize' => 0,
...
$config['ResourceType'][] = Array(
		'name' => 'Flash',
		'url' => $baseUrl . 'editors/flash',
		'directory' => $baseDir . 'editors/flash',
		'maxSize' => 0,
